...
use crate::{FromPlayer, Laser, Materials, Player, PLAYER_RESPAWN_DELAY, PlayerReadyFire, PlayerState, Speed, TIME_STEP, WinSize};
...
impl Plugin for PlayerPlugin{
    fn build(&self, app: &mut AppBuilder) {
        ...
        .add_startup_stage("game_setup_actors",
...
fn player_spawn(mut commands: Commands, materials: Res<Materials>, win_size: Res<WinSize>, time: Res<Time>, mut player_state: ResMut<PlayerState>) {
...
fn player_fire(mut commands: Commands, kb: Res<Input<KeyCode>>, materials: Res<Materials>, mut query: Query<(&Transform, &mut PlayerReadyFire),  With<Player>>,) {
